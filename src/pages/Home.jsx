...
const Home = () => {
  ...
  const handleAddToCart = async (item, e) => {
    e.stopPropagation();
    try {
      await addToCart({ id: item.id, variantId: item.variants?.[0]?.id || null }, 1);
  ...
  return (
    <div className="home-page">
      ...
      <section className="home-hero-section">
        <video className="home-hero-video" src="banner3.mp4" autoPlay loop muted playsInline />
        <div className="home-hero-overlay">
          <h1 className="home-hero-title">Just Feel The Power</h1>
          <p className="home-hero-subtitle">
            Phụ kiện chạy bộ cao cấp — tối ưu hiệu suất, thoải mái và sẵn sàng cho mọi cung đường.
          </p>
          <Link to="/products" className="home-btn">Khám phá ngay</Link>
        </div>
      </section>
            ...
            return (
              ...
              >
                <div className="home-card-container">
                  <div className="home-card-top" style={{ backgroundImage: `url(${image})` }} />
                  <div className={`home-card-bottom ${activeId === item.id ? "home-clicked" : ""}`}>
                ...
                <div className="home-card-inside" onClick={(e) => e.stopPropagation()}>
                  ...
                  <div className="home-card-contents">
                    <table>
                      <tbody>
                        <tr><th>Category</th><td>{item.categories?.[0]?.name || "N/A"}</td></tr>
                        <tr><th>Brand</th><td>{item.brand || "N/A"}</td></tr>
                        <tr><th>Price</th><td>{price.toLocaleString()} ₫</td></tr>
                      </tbody>
                    </table>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="home-scroll-overlay">
                    ...
                    <div className="home-scroll-actions">
                      <button onClick={(e) => handleAddToCart(item, e)} className="home-scroll-btn">
